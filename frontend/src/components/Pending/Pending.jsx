	...
	return (
		<div className={styles.pending}>
			...
			<div className={styles.pendingDisplay}>
				...
				<div className={styles.penidngApproval}>
					Pending approval by ScholarChain
				</div>
				<div className={styles.checkEmail}>
					*please check your email for the verification and login again
				</div>
				...
				<div className={styles.backToHomeButton} onClick={onloginContainerClick}>
					<div className={styles.backToHomeButtonChild} />
					<div className={styles.backToHome}>Proceed Login</div>
				</div>
			</div>
		</div>
	);
